...
const footer = () => {
  return (
    ...
    <footer className="container mx-auto md:px-20 px-6 bg-white sm:p-6">
      <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <Link href="/" className="flex items-center">
                  
                  <span className="self-center text-2xl font-semibold whitespace-nowrap ">TailBlogs</span>
              </Link>
          </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center">© 2022 <Link href="/" className="hover:underline">TailBlogs</Link>. All Rights Reserved.
          </span>
